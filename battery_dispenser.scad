...
/* [Basic Parameters] */
// A list of the batteries to generate for yes("AAA", "AA", "C", "D","9V", "18650", "123A", "14250", and "21700")
Battery_List = ["AAA", "AAA", "AA", "AA", "9V", "14250"];
...
module GenerateScrewTab()
{
    difference()
    {
        ...
        tab_width = Screw_Head_Diameter + Wall_Thickness*4  + Slide_Space*2;
